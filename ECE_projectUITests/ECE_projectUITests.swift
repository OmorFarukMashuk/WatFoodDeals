...
//
        ...
        let newsStaticText = app.staticTexts["NEWS"]
        newsStaticText.tap()
        app.staticTexts["Mongolian Grill Wrap and fries for only $6"].tap()
        app.staticTexts["Anty's Kitchen 10% off on orders above 10$"].tap()
        app.staticTexts["Free Soup with Daily Special Lunch Deals"].tap()
        ...
        let window = app.children(matching: .window).element(boundBy: 0)
        let element = window.children(matching: .other).element(boundBy: 3).children(matching: .other).element
        element.tap()
        element.tap()
        element.tap()
        element.tap()
        ...
        window.children(matching: .other).element(boundBy: 5).children(matching: .other).element.tap()
        ...
        app.staticTexts["Social"].tap()
        
        let element2 = window.children(matching: .other).element(boundBy: 7).children(matching: .other).element
        element2.tap()
        app.staticTexts["Click on the Names to go to the FB Link"].tap()
        element2.tap()
        app.buttons["Aunty's Kitchen"].tap()
